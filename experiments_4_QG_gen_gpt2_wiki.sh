# wiki data
output_path="/content/acsqg/Datasets/processed/Wiki10000/"
...
PYTHONIOENCODING=utf-8 python3 QG_gpt2_generate.py  \
    ...
    --filecache "/content/gdrive/MyDrive/QA_Generation/Datasets/processed/${data_file_prefix}.sentences.augmented.${st_idx}_${ed_idx}.cache.qg.gpt2.pth" \
